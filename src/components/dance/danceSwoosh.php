...
class danceSwoosh
{
    ...
    {
        echo "
        <section class='jazz--swoosh' style='padding-top:0px;'>
        <img src='../assets/images/dance/dance-swoosh.png' class='jazz--swoosh__img' style='margin-left:1193px; margin-top:60px;'>
        </section>
        ";
    }
}
