    ...
    public function render()
    {
        ...
        <section class='container section exploreHaarlem'>
            <article class='exploreHaarlem__textBox'>
                <h1>Explore <span class='exploreHaarlem__haarlem exploreHaarlem__haarlem--jazz'>Haarlem</span> before the event! And meet like-minded people</h1>
            ...
            <article class='exploreHaarlem__container'>
                ...
                <section class='exploreHaarlem__text'>
                    ...
                    <img class ='exploreHaarlem__icon' src='../assets/images/jazz/icons/walking-man.png' alt=''>
